...
#task = threading.Thread(target=updatevalues(), daemon=True)
#task.start()
task1 = threading.Thread(target=read_sensor, daemon=True)
task1.start()
task2 = threading.Thread(target=run_server(), daemon=True)
task2.start()
task3 = threading.Thread(target=updatevalues(a), daemon=True)
task3.start()
...
lbl = tk.Label(root, textvariable=var2, width=20, height=2, font=('Consolas', 15, 'bold'))
...
b = tk.Button(root, text="Cal 4.0", width=8, height=1, bg="red", font=("Arial",14), command=lambda: start_Cal4_Mode(var3))
b.grid(row=2,column=0)
c = tk.Button(root, text="Cal 7.0", width=8, height=1, bg="green", font=("Arial",14), command=lambda: start_Cal7_Mode(var4))
c.grid(row=1,column=0)
d = tk.Button(root, text="Cal 10.0", width=8, height=1, bg="gray", font=("Arial",14), command=lambda: start_Cal10_Mode(var5))
d.grid(row=3,column=0)
e = tk.Button(root, text="Cal  EC", width=8, height=1, bg="blue", font=("Arial",14), command=lambda: start_CalEC_Mode(var6))
e.grid(row=4,column=0)
b1=tk.Button(root, text="Trend PH",bg="green", font=("Arial",14),command=helloCallBack1)
b1.grid(row=5, column=0)
b2=tk.Button(root, text="Trend EC",bg="green", font=("Arial",14),command=helloCallBack2)
