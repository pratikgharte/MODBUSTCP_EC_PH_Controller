...
#task1 = threading.Thread(target=, daemon=True)
task.start()
task1.start()
root = tk.Tk()
...
z = tk.Button(root, text="Menu", bg="black", fg = "white", width=8, height=1, font=("calibri",14) , command=create_window)
...
PH_plus = tk.Button(root, text="PH +", command=PH_plus, font=("calibri", 12))
PH_plus.grid(row=4,column=10)
PH_minus = tk.Button(root, text="PH -", command=PH_minus, font=("calibri", 12))
PH_minus.grid(row=4,column=11)

PH_plus1 = tk.Button(root, text="PH +", command=PH_plus1, font=("calibri", 12))
PH_plus1.grid(row=7,column=10)
PH_minus1 = tk.Button(root, text="PH -", command=PH_minus1, font=("calibri", 12))
PH_minus1.grid(row=7,column=11)

EC_plus = tk.Button(root, text="EC +", command=EC_plus, font=("calibri", 12))
EC_plus.grid(row=4,column=12)
EC_minus = tk.Button(root, text="EC -", command=EC_minus, font=("calibri", 12))
EC_minus.grid(row=4,column=13)

EC_plus1 = tk.Button(root, text="EC +", command=EC_plus1, font=("calibri", 12))
EC_plus1.grid(row=7,column=12)
EC_minus1 = tk.Button(root, text="EC -", command=EC_minus1, font=("calibri", 12))
...
#background_img = PhotoImage(file = f"farmfluence-Logo.png")
